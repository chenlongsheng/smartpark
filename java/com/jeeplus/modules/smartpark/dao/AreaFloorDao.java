 ...
 */
@MyBatisDao
public interface AreaFloorDao extends TreeDao<Area> {



	
    void insertFloor(Area area);
    
    void  updateFloor(@Param(value = "id") String id, @Param(value = "name") String name);
	
    
    List<MapEntity>  getFloorList(@Param(value = "parentId") String parentId);
    
    
    void  deleteFloor(@Param(value = "id") String id);
